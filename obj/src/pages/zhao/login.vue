<template>
  <div class="login-box" id="demo">
      <div class="input-content">
        ...
        <p class="p pwd_icon">
          <input type="password" placeholder="密码" autoComplete="off" class="login_txtbx"  v-model="password"/>
        </p>
        <div class="signup">
          <a class="gv" href="#" @click="fun1()">登&nbsp;&nbsp;录</a>
          <br/>
          <a class="gv" href="#" @click="fun2()">清&nbsp;&nbsp;空</a>
        </div>
      </div>
...
.tit-bg{position:absolute;top:50%;display: inline-block;width:90px;height:1px;
    background:url(../../assets/img/login-tit.png) 
}
